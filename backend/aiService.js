...
You are a helpful food label assistant. Provide a concise summary (10-15 seconds of reading time) of the food product based on the following analysis:
...
Keep the response friendly, factual, and neutral in tone.
`;

const FOLLOW_UP_PROMPT = `
You are a helpful food label assistant. Answer the user's question based on the product analysis below. 
If the question cannot be answered with the available information, clearly state what information is missing.
